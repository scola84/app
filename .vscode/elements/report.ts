          ...
          <scola-panel height="flex">
              ...
              <scola-content id="mix" flow="column">
                ...
                <scola-card flow="wrap">
                  ...
                  <!-- <scola-space flow="column"></scola-space> -->
                  <scola-input-range>
                    <label for="range" slot="label">
                    Range
                    <scola-format code="input.range" data-value="0" slot="after"></scola-format>
                    </label>
                    <span slot="prefix">0%</span>
                    <!-- <scola-icon name="bell" slot="before"></scola-icon> -->
                    <input type="range" value="40" min="0" max="100" id="range" name="range" step="10" />
                    <!-- <scola-icon name="bell" slot="after"></scola-icon> -->
                  ...
                  <scola-input-file>
                    ...
                    <label for="files">
                      <scola-format code="input.file" data-count="0"></scola-format>
                    </label>
                  </scola-input-file>
                  <scola-space flow="column"></scola-space>
                  <scola-input>
                  ...
                  <scola-input>
                    ...
                    <!-- <scola-icon slot="before" name="bell"></scola-icon> -->
                ...
                <scola-form-fill id="fill-locale" url="/locales/data.json" wait>
                  <scola-content flow="wrap">
                    <scola-input-popout name="theme">
                      ...
                      <scola-popout halign="left">
                        ...
                        <scola-dialog inline no-outside>
                          <scola-card>
                            <scola-input-radio flow="column" state-as="none">
                    ...
                    <scola-input-select>
                      ...
                      <scola-space flow="column"></scola-space>
                      <scola-input flow="column" inline>
                        <label slot="label">Dark mode</label>
                        <scola-input-radio flow="column" slot="input">
                          <input type="radio" name="theme" value="dark" />
                          <span>Whether to enable dark mode. Whether to enable dark mode. Whether to enable dark mode. Whether to enable dark mode. Whether to enable dark mode.</span>
                        </scola-input-radio>
                        <scola-input-radio flow="column" slot="input">
