        ...
        <scola-cell rows="6" cols="10">
          ...
          <scola-panel height="flex">
              ...
              <scola-bar slot="footer" no-text>
                <scola-panel-button slot="buttons" event="scola-popout-hide">
                  <span>Annuleren</span>
                </scola-panel-button>
                <scola-panel-button slot="buttons" event="scola-form-submit">
                  <span>Opslaan</span>
                </scola-panel-button>
              </scola-bar>
            </scola-panel>
          ...
          <scola-cell rows="3" cols="5">
            <scola-card>
              <scola-bar no-inside no-outside>
                <span slot="text">Test</span>
                <scola-icon-button slot="buttons">
                  <scola-icon name="bell"></scola-icon>
                </scola-icon-button>
              </scola-bar>
